...
const DetailPlus = ({ onAddCart, openImage }) => {
    ...
    return (
        <div className="shoes-cont">
            <figure>
                <img src="https://images.unsplash.com/photo-1575537302964-96cd47c06b1b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="운동화" className='modal-image'
